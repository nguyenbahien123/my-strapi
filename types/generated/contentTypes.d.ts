...
export interface ApiApartmentOwnershipApartmentOwnership
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    apartment_unit: Schema.Attribute.Relation<
      'oneToOne',
      'api::apartment-unit.apartment-unit'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::apartment-ownership.apartment-ownership'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiApartmentUnitApartmentUnit
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    AreaSquareMeters: Schema.Attribute.Decimal;
    BuildingCode: Schema.Attribute.Relation<
      'oneToOne',
    ...
    publishedAt: Schema.Attribute.DateTime;
    StatusCode: Schema.Attribute.Relation<'oneToOne', 'api::status.status'>;
    UnitCode: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiBuildingServiceBuildingService
  ...
  info: {
    ...
    pluralName: 'building-services';
    singularName: 'building-service';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiFamilyMemberFamilyMember
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    FamilyCode: Schema.Attribute.Relation<'oneToOne', 'api::family.family'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    RelationshipToHead: Schema.Attribute.String;
    ResidentCode: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiGenderGender extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Description: Schema.Attribute.Text;
    GenderName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiInvalidTokenInvalidToken
  extends Struct.CollectionTypeSchema {
  collectionName: 'invalid_tokens';
  info: {
    displayName: 'Invalid Token';
    pluralName: 'invalid-tokens';
    singularName: 'invalid-token';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    expiredAt: Schema.Attribute.DateTime & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::invalid-token.invalid-token'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiResidentResident extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    zaloId: Schema.Attribute.Text & Schema.Attribute.Unique;
  };
}
